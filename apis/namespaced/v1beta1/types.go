...
// +kubebuilder:resource:scope=Namespaced,categories={crossplane,providerconfig,gcp}
...
// +kubebuilder:resource:scope=Namespaced,categories={crossplane,providerconfig,gcp-beta}
// +kubebuilder:storageversion
...
// A ClusterProviderConfig configures a GCP provider.
// +kubebuilder:subresource:status
// +kubebuilder:printcolumn:name="AGE",type="date",JSONPath=".metadata.creationTimestamp"
// +kubebuilder:printcolumn:name="SECRET-NAME",type="string",JSONPath=".spec.credentials.secretRef.name",priority=1
