...
import (
	...
	googlebeta "github.com/hashicorp/terraform-provider-google-beta/google-beta/provider"
	"k8s.io/apimachinery/pkg/runtime"

	clusterapis "github.com/upbound/provider-gcp-beta/apis/cluster"
	namespacedapis "github.com/upbound/provider-gcp-beta/apis/namespaced"
	"github.com/upbound/provider-gcp-beta/config"
)

func TestRoundTrip(t *testing.T) {
	schema := googlebeta.Provider()
