...
const (
	...
	SelfPackagePath = "github.com/upbound/provider-gcp-beta/config/common"

	// ExtractResourceIDFuncPath holds the GCP resource ID extractor func name
	ExtractResourceIDFuncPath = "github.com/upbound/provider-gcp-beta/config/common.ExtractResourceID()"
	ExtractProjectIDFuncPath  = "github.com/upbound/provider-gcp-beta/config/common.ExtractProjectID()"
	ExtractFolderIDFuncPath   = "github.com/upbound/provider-gcp-beta/config/common.ExtractFolderID()"
